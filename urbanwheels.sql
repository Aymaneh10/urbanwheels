...
CREATE TABLE `bookings` (
  ...
  `pickup_location` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `dropoff_location` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `vehicles` (
  ...
  `transmission` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicles` (`vehicle_id`) ON DELETE CASCADE ON UPDATE CASCADE,
